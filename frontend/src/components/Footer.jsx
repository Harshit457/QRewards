    ...
    return (
      <footer className="bg-white py-4 text-center text-slate-500 text-sm">
        <div className="container-custom">
          <p>© {new Date().getFullYear()} QReward. All rights reserved.</p>
        </div>
      </footer>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">QReward</span>
            </Link>
            <p className="text-slate-300">
              The most trusted platform for legitimate QR code promotions and
              instant prizes.
            </p>
